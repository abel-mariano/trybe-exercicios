...
// Selecionar, pelos ids, os campos da página
...
button.addEventListener('click', (event) => {
  // Usando o preventDefault() para evitar que, ao clicar no botão, ele recarregue a página
  event.preventDefault();

  // Objeto cujas chaves são os tipos a serem validados. Por exemplo, a chave CPF valida se o campoDeTexto.value é um CPF.
  ...
  // O objeto 'campos' possui as chaves com o mesmo nome das opções do seletor em nossa página. Assim, podemos selecionar a chave de acordo com o selecionado no HTML
